...
function buildContactFormConfig() {
    return [
        ...
        'address' => [
            'type' => 'text', 'regex' => 'address',
            'label' => 'Address', 'name' => 'address', 'id' => 'address',
            'errorMsg' => 'Address must start with a number followed by letters.',
            'error' => '', 'required' => true, 'value' => ''
        ],
        'city' => [
            'type' => 'text', 'regex' => 'city',
            'label' => 'City', 'name' => 'city', 'id' => 'city',
            'errorMsg' => 'You must enter a valid city (letters only).',
            'error' => '', 'required' => true, 'value' => ''
        ],
        'state' => [
            'type' => 'select',
        ...
        'zip' => [
            'type' => 'text', 'regex' => 'zip',
            'label' => 'Zip Code', 'name' => 'zip', 'id' => 'zip',
            'errorMsg' => 'You must enter a valid zip code (5 digits).',
            'error' => '', 'required' => true, 'value' => ''
        ],
        'phone' => [
            'type' => 'text', 'regex' => 'phone',
        ...
        'age' => [
            'type' => 'radio',
            'label' => 'Choose an Age Range', 'name' => 'age', 'id' => 'age',
        ...
        'contacts' => [
            'type' => 'checkbox',
            'label' => 'Select One or More Options', 'name' => 'contacts', 'id' => 'contacts',
