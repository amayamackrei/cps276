...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'amreid';//this will be your WCC username
      $dbUsr = 'amreid';//this will be your WCC username
      $dbPass = '3I3cELMuJfTJ0zs';//this will be the password found in the video.
